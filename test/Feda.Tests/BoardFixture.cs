...
public sealed class BoardFixture
{
    ...
    public void WhitePawnAttacks_Assert()
    {
        ...
        data[(int)Square.A8] = Array.Empty<Square>();
        data[(int)Square.B8] = Array.Empty<Square>();
        data[(int)Square.C8] = Array.Empty<Square>();
        data[(int)Square.D8] = Array.Empty<Square>();
        data[(int)Square.E8] = Array.Empty<Square>();
        data[(int)Square.F8] = Array.Empty<Square>();
        data[(int)Square.G8] = Array.Empty<Square>();
        data[(int)Square.H8] = Array.Empty<Square>();
    ...
    public void BlackPawnAttacks_Assert()
    {
        // Arrange
        var data = new Square[64][];
        data[(int)Square.A1] = Array.Empty<Square>();
        data[(int)Square.B1] = Array.Empty<Square>();
        data[(int)Square.C1] = Array.Empty<Square>();
        data[(int)Square.D1] = Array.Empty<Square>();
        data[(int)Square.E1] = Array.Empty<Square>();
        data[(int)Square.F1] = Array.Empty<Square>();
        data[(int)Square.G1] = Array.Empty<Square>();
        data[(int)Square.H1] = Array.Empty<Square>();
